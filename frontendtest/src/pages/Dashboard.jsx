...
export default function Dashboard() {
  ...
  // Fetch 24h historical data on startup
  useEffect(() => {
    const fetchHistory = async () => {
      try {
        const res = await fetch(`${BACKEND_URL}/api/prices/history?symbols=${SYMBOLS.join(",")}&period=24h`);
        ...
        if (data.success) {
          ...
          setHistory((prevHistory) => {
            ...
            for (const symbol of SYMBOLS) {
              ...
              // Keep last 24h (~288 points at 5-min intervals)
